# temp_sales_load_insert.py

from config import Config
from Variable import Variables

v = Variables()
v.set("SCRIPT_NAME", "TEMP_SALES_INSERT")
...
# 1️⃣ Insert into temporary fact table with dimension keys
insert_tmp_query = f"""
...
print("Temporary SALES fact table loaded with dimension keys.")